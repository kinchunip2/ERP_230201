                        ...
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('common.Brand') }}</h3>
                                ...
                                <ul class="d-flex">
                                    ...
                                    <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{route('brand.csv_upload.create')}}"><i class="ti-export"></i>{{__('common.Upload Via CSV')}}</a></li>
                                        @endif
                                </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <input name="name" class="primary_input_field" placeholder="{{ __('product.Brand Name') }}"
                                                       type="text" required>
