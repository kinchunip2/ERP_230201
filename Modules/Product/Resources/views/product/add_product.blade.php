                            ...
                            <form action="{{route("add_product.store")}}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="">{{__('product.Product Type')}}
                                                *</label>
                                            <select class="primary_select mb-15 product_type" name="product_type"
                                                    data-parsley-errors-container="#product_type_error_container"
                                                    id="product_type">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="product_name"> {{__("common.Product Name")}} *</label>
                                            <input class="primary_input_field" name="product_name"
                                                   placeholder="{{__("common.Product Name")}}" type="text"
                                                   value="{{old('product_name')}}" required id="product_name">
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="product_sku_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="product_sku">{{__("common.Product SKU")}}</label>
                                            <input type="text" name="product_sku" id="product_sku"
                                                   class="primary_input_field" value="{{old('product_sku')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 d-none" id="product_origin_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="origin">{{__("common.Part Number")}}</label>
                                            <input type="text" name="origin" id="origin" class="primary_input_field"
                                                   value="{{old('origin')}}">
                                            ...
                                            <div class="double_label d-flex justify-content-between">
                                                ...
                                                <label class="primary_input_label green_input_label" for="">
                                                    <a href="#" data-toggle="modal"
                                                       data-target="#new_unit">{{__('product.New Unit')}}<i
                                    ...
                                    <div class="col-lg-4" id="barcode_type_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="barcode_type">{{__('product.Barcode Type')}}</label>
                                    ...
                                    <div class="col-lg-4" id="brand_div">
                                        <div class="primary_input mb-15">
                                            <div class="double_label d-flex justify-content-between">
                                                <label class="primary_input_label"
                                                       for="">{{__("common.Brand")}} </label>
                                                <label class="primary_input_label green_input_label" for="">
                                                    <a href="#" data-toggle="modal"
                                                       data-target="#new_barnd">{{__('product.New Brand')}}<i
                                                            class="fas fa-plus-circle"></i></a></label>
                                            </div>
                                    ...
                                    <div class="col-lg-4" id="category_div">
                                        <div class="primary_input mb-15">
                                            <div class="double_label d-flex justify-content-between">
                                                ...
                                                <label class="primary_input_label green_input_label" for="">
                                                    <a href="#" data-toggle="modal"
                                                       data-target="#Item_Details">{{__('product.New Category')}}<i
                                                            class="fas fa-plus-circle"></i></a></label>
                                            </div>
                                            <select name="category_id" id="category_id"
                                                    class="primary_select mb-15 category">
                                                <option value="">{{__('product.Select Category')}}</option>
                                                @foreach($categories as $key=>$category_value)
                                                    <option
                                                        value="{{$category_value->id}}">{{$category_value->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-4" id="sub_category_div">
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="double_label d-flex justify-content-between">
                                                ...
                                                <label class="primary_input_label green_input_label" for="">
                                                    <a href="#" data-toggle="modal"
                                                       data-target="#new_sub_cat">{{__('product.New Sub Category')}}<i
                                                            class="fas fa-plus-circle"></i></a></label>
                                            </div>
                                            <select class="primary_select mb-15 sub_category" id="sub_category_list"
                                                    name="sub_category_id">
                                                <option>{{__('product.Select Sub Category')}}</option>
                                                @foreach($sub_categories as $key=>$sub_category_value)
                                                    <option
                                                        value="{{$sub_category_value->id}}">{{$sub_category_value->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-4" id="model_div">
                                        <div class="primary_input mb-15">
                                            <div class="double_label d-flex justify-content-between">
                                                ...
                                                <label class="primary_input_label green_input_label" for="">
                                                    <a href="#" data-toggle="modal"
                                                       data-target="#new_model">{{__('product.New Model')}}<i
                                                            class="fas fa-plus-circle"></i></a></label>
                                            </div>
                                    ...
                                    <div class="col-lg-12" id="select_product">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="selected_product_id">{{__('product.Select Product')}}</label>
                                            <select class="primary_select mb-15" id="selected_product_id"
                                                    name="selected_product_id[]" multiple
                                                    data-parsley-errors-container="#selected_product_id_error_container">
                                                @foreach($productSkus as $key => $productSku)
                                                    <option
                                                        value="{{$productSku->id}}">{{$productSku->product->product_name}}
                                    ...
                                    <div class="col-lg-4" id="alert_quantity_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__("common.Alert Quantity")}} </label>
                                            <div class="">
                                                <input type="number" min="1" step="1" name="alert_quantity"
                                                       id="alert_quantity" class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="product_image_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__('product.Product Image')}}</label>
                                    ...
                                    <div class="col-lg-4" id="purchase_price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__("common.Purchase Price")}}</label>
                                            <div class="">
                                                <input type="number" name="purchase_price" id="purchase_price" value="0" step="0.01"
                                    ...
                                    <div class="col-lg-4" id="selling_price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="">{{__("common.Selling Price")}}
                                                *</label>
                                            <div class="">
                                                <input type="number" step="0.01" name="selling_price"
                                                       required="required" id="selling_price" value="0"
                                                       class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="hourly_rate_div" style="display:none;">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="">{{__("common.Hourly Rate")}}
                                                *</label>
                                            <div class="">
                                                <input type="number" step="0.01" name="hourly_rate" id="hourly_rate"
                                                       value="0" class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="min_selling_price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__("common.Min. Selling Price")}} </label>
                                            <div class="">
                                                <input type="number" name="min_selling_price" id="min_selling_price" step="0.01"
                                                       value="0" class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="combo_sell_Price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__("common.Combo Selling Price")}}  </label>
                                            <div class="">
                                                <input type="number" step="0.01" name="combo_selling_price"
                                                       id="combo_selling_price" value="0" class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4" id="other_currency_price">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__("common.Price of Other Currency")}}  </label>
                                            <div class="">
                                                <input type="text" name="price_of_other_currency"
                                                       id="price_of_other_currency" value="0"
                                                       class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3" id="tax_div">
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="">
                                                <input type="number" min="0" max="99" name="tax" id="tax" value="0" step="0.01"
                                                       class="primary_input_field">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-1" id="tax_type_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__("common.Tax Type")}}  </label>
                                            <div class="">
                                                <input type="text" name="tax_type" id="tax_type"
                                                       class="primary_input_field tax_type" value="%" readonly>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 choose_variant" style="display: none;">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label"
                                                   for="">{{__('product.Choose Variant')}}</label>
                                            <select class="primary_select mb-15 selected_variant"
                                                    name="selected_variant[]" multiple>
                                                @foreach($variants as $key=>$variant_value)
                                                    <option
                                                        value="{{$variant_value->id}}">{{$variant_value->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="submit_btn text-center ">
                                        <button class="primary-btn semi_large2 fix-gr-bg submit"><i
                                                class="ti-check"></i>{{__("common.Add Product")}} </button>
                                        <button class="primary-btn semi_large2 fix-gr-bg submitting" disabled
                                                style="display: none;"><i
                                                class="ti-check"></i>{{__("common.Adding Product")}} </button>
                                    </div>
                                </div>
                            </form>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <input name="name" class="primary_input_field"
                                                                   placeholder="{{ __('product.Category Name') }}" required="1" type="text">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <input name="code" class="primary_input_field"
                                                                   placeholder="{{ __('product.Category Code') }}" type="text">
                                                            <span class="text-danger" id="name_error"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            ...
                                                            <input name="description" class="primary_input_field"
                                                                   placeholder="{{__('product.Put Some Description')}}"
                                                                   type="text">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('common.Name') }} *</label>
                                                            <input name="name" class="primary_input_field"
                                                                   placeholder="{{ __('product.Unit Type Name') }}"
                                                                   type="text" required>
                                                            <span class="text-danger" id="name_error"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('common.Name') }} *</label>
                                                            <input name="name" class="primary_input_field"
                                                                   placeholder="{{ __('product.Category Name') }}" type="text">
                                                            <span class="text-danger" id="name_error"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-12">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="primary_input mb-25">
                                                            <label class="primary_input_label"
                                                                   for="">{{ __('common.Name') }} *</label>
                                                            <input name="name" class="primary_input_field"
                                                                   placeholder="{{ __('product.Brand Name') }}"
                                                                   type="text" required>
                                                            <span class="text-danger" id="name_error"></span>
                                                        </div>
                                                    </div>
...
@push("scripts")
    <script type="text/javascript">
        ...
        function calculatePrice() {
            "use strict";
            var qtys = $("input[name='selected_product_qty[]']").map(function () {
                return $(this).val();
            }).get();
            var prices = $("input[name='selected_product_price[]']").map(function () {
                return $(this).val();
            }).get();
            var tax = $("input[name='selected_product_tax[]']").map(function () {
                return $(this).val();
            }).get();
            var sum = 0;
                ...
                success: function (response) {
                    ...
                    $.each(response, function (key, item) {
                        if (item.status) {
                            ...
                            $(".unit").append(`<option value="${item.id}">${item_name}</option>`);
                        }
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $(".selected_variant").unbind().on("change", function () {
                   ...
                   <th scope="col">${ trans('js.Alert Qty')}</th>
                   <th scope="col">${ trans('js.Purchase Price')}</th>
                   <th scope="col">${ trans('js.Min Selling Price')}</th>
                   <th scope="col">${ trans('js.Selling Price')}</th>
                   <th scope="col">${ trans('js.Product Images')}</th>
                   <th>&nbsp;</th>`;
                    head += "</tr>";
                    row_list += `<td>
                        ...
                        <td>
                           <div class="primary_file_uploader w_210px">
                              ...
                              <button class="" type="button">
                              <label class="primary-btn small fix-gr-bg" for="document_file_2">${ trans('js.Browse') }</label>
                ...
                $(".product_type").unbind().on("change", function () {
                    let type = $(this).val();
                    ...
                    if (type === "Variable") {
                        ...
                        $("#combo_selling_price").attr("disabled", false);
                ...
                $(document).on("click", '.add_variant_row', function () {
                    ...
                    row_list += '<td>' +
                        ...
                        '<input class="primary-input" type="text" id="placeholderFileOneName" placeholder="'+trans('js.Browse file')+'" readonly="">' +
                        '<button class="" type="button">' +
                        '<label class="primary-btn small fix-gr-bg" for="document_file_' + i + '">'+trans('js.Browse')+'</label>' +
                ...
                $(".category").unbind().on('change', function () {
                ...
                $("#selected_product_id").unbind().on("change", function () {
                    var i = 0;
                    let sku_id = $(this).val();
                    var purchase_price = $("#purchase_price").val();
                    var selling_price = $("#selling_price").val();
                    $.post('{{ route('product_sku.get_product_price') }}', {
                        _token: '{{ csrf_token() }}',
                        sku_id: sku_id,
                        ...
                        $.each(data.name, function (index, value) {
                            ...
                            $(".form").append('<div class="col-lg-4 row_id_' + index + '">' +
                                ...
                                '<div class="primary_input mb-15">' +
                                '<input class="primary_input_field" name="selected_product_qty[]" placeholder="'+trans('js.Quantity')+'" type="number" min="0" onkeyup="calculatePrice()" step="1" value="1">' +
                                '</div>' +
                                '</div>' +
                                '<div class="col-lg-3 row_id_' + index + '">' +
                                '<div class="primary_input mb-15">' +
                                '<input class="primary_input_field" name="selected_product_price[]" placeholder="'+trans('js.Price')+'" type="number" min="0" step="0.01" value="' + value.selling_price + '">' +
                                '</div>' +
                                '</div>' +
                                '<div class="col-lg-1 row_id_' + index + '">' +
                                '<div class="primary_input mb-15">' +
                                '<input class="primary_input_field" name="selected_product_tax[]" placeholder="'+trans('js.Tax')+'" type="number" min="0" step="0.01" value="' + value.tax + '">' +
                                '</div>' +
                                '</div>' +
                                '</div>');
                        });
