        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="">
                    <div class="row">
                        <div class="col-xl-6">
                            <img src="{{ asset($product->image_source ??'public/backEnd/img/no_image.png' ) }}" id="view_product_image" style="height:200px;">
                        </div>
                                            ...
                                            <tr class="variant_row_lists">
                                                <td>
                                                    @if (@$comboProduct->productSku->product->product_type == "Single")
                                                        <img style="height:70px;" src="{{ asset(@$comboProduct->productSku->product->image_source?? 'public/backEnd/img/no_image.png') }}"></td>
                                                    @else
                                                        <img style="height:70px;" src="{{ asset(@$comboProduct->productSku->product_variation->image_source ?? 'public/backEnd/img/no_image.png') }}"></td>
                                                    @endif
                                                <td>
