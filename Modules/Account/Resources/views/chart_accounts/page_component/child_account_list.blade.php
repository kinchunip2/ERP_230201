        ...
        <div class="dropdown CRM_dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right"
                 ...
                 @if ($child_account->id > "34")
                    ...
                    <a onclick="confirm_modal('{{route('char_accounts.destroy',$child_account->id)}}');" class="dropdown-item ">{{__('common.Delete')}}</a>
                 @else
                     <a href="#" data-toggle="modal" data-target="#RenameAccount" class="dropdown-item rename_account" onclick="get_data_modal({{$child_account}})" type="button">{{ __('common.Edit') }}</a>
                 @endif
