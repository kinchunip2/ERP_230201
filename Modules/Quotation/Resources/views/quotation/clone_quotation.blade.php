                                        ...
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="{{ __('quotation.Date') }}" class="primary_input_field primary-input date form-control"
                                                                   id="startDate" type="text"
                                                                   name="date" value="{{date('m/d/Y', strtotime($quotation->date))}}"
                                                                   autocomplete="off">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="{{ __('quotation.Valid Till Date') }}" class="primary_input_field primary-input date form-control" id="valid_till_date" type="text" name="valid_till_date" value="{{ date('m/d/Y', strtotime($quotation->valid_till_date)) }}" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <button class="" type="button">
                                                        <i class="ti-calendar" id="start-date-icon"></i>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input type="text" name="po" class="primary_input_field" value="{{ $quotation->po }}" placeholder="{{ __('quotation.PO') }}">
