                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <select class="primary_select mb-15 contact_type" name="customer_id">
                                                <option selected disabled>{{ __('common.Select One') }}</option>
                                ...
                                <div class="row">
                                        ...
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="{{ __('quotation.Date') }}" class="primary_input_field primary-input date form-control" id="startDate" type="text" name="date" value="{{date('m/d/Y')}}" autocomplete="off">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="{{ __('quotation.Valid Till Date') }}" class="primary_input_field primary-input date form-control" id="valid_till_date" type="text" name="valid_till_date" value="{{date('m/d/Y')}}" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <button class="" type="button">
                                                        <i class="ti-calendar" id="start-date-icon"></i>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input type="text" name="shipping_address" class="primary_input_field" value="{{old('shipping_address')}}" placeholder="{{__('quotation.Shipping Address')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input type="text" name="po" class="primary_input_field" value="" placeholder="{{__('quotation.PO')}}">
    ...
    <script type="text/javascript">
        ...
        function productTax(id, type) {
                ...
                $.each($('.tax'), function (index, value) {
                    ...
                    product_tax += checkNaN(parseFloat(amount));
                });
                if (product_tax > 0){
                    $('.product_tax').show();
                }else{
            ...
            function calcutionTaxDiscount(tr){
                let taxParcentage = checkNaN(parseFloat(tr.find('.tax').val()));
                let productPrice =  checkNaN(parseFloat(tr.find('.product_price ').val()));
                let discount =  checkNaN(parseFloat(tr.find('.discount ').val()));
                let qty =  checkNaN(parseInt(tr.find('.quantity').val()));
                let discount_price = (productPrice * discount) / 100;
                let netSubTotal = (( productPrice - discount_price) * qty) * taxParcentage /100;
                tr.find('.tax').attr('net-sub-total',netSubTotal.toFixed(2))
            }

            function productDiscount() {
                let product_discounts = 0;
                $.each($('.discount'), function (index, value) {
                    let amount = checkNaN(parseFloat($(this).val()));
                ...
                $('.product_discounts').val(product_discounts.toFixed(2));
            }
        ...
        function SubTotal() {
            ...
            $.each($('.product_subtotal'), function (index, value) {
                ...
                total_amount += checkNaN(parseFloat(amount));
            });
        ...
        function grandTotal()
        {
            let amount = checkNaN(parseFloat($('.total_sub_total').val()));
            let discount = checkNaN(parseFloat($('.product_discounts').val()));
            let tax = checkNaN(parseFloat($('.product_tax_input').val()));

            let final_amount = (amount + tax) - discount ;
            $('.total_price').val(final_amount.toFixed(2));
        }

        function billingInfo() {
            //billing_info
            let total_discount = checkNaN(parseFloat($('.total_discount').val()));
            let total_tax = checkNaN(parseFloat($('.total_tax').val()));
            let shipping_charge = checkNaN(parseFloat($('.shipping_charge').val()));
            let other_charge = checkNaN(parseFloat($('.other_charge').val()));
            let total_amount = checkNaN(parseFloat($('.total_price').val()));
            ...
            let final_amount = (total_amount + calculated_total_tax + shipping_charge + other_charge) - calculated_total_discount;
        ...
        function selectProduct(el) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 1)
                        toastr.error(trans('js.This item is already added'));
                    else {
