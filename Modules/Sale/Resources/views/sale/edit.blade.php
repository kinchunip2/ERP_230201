                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        <div class="primary_input mb-15">
                                            ...
                                            <select class="primary_select mb-15 sale_type" id="sale_type" name="sale_type">
                                                <option value="1" {{$sale->type == 1 ? 'selected' : ''}}>{{ __('sale.Sale') }}</option>
                                                <option value="2" {{$sale->type == 2 ? 'selected' : ''}}>{{ __('extrauser::extrauser.Affiliate Sale') }}</option>
                                                <option value="2" {{$sale->type == 3 ? 'selected' : ''}}>{{ __('extrauser::extrauser.Commissioner Sale') }}</option>
                                            </select>
