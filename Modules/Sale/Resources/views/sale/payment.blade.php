                                                       ...
                                                       <div class="col-md-6 col-lg-6 col-sm-12">
                                                           <div class="primary_input mb-15">
                                                               ...
                                                               <input type="text" id="amount0" name="amount[]"
                                                                      onkeyup="getAmount('0')"
                                                                      class="primary_input_field input_amounts cash_payment" value="{{ $sale->payable_amount - ($sale->payments->sum('amount') - $sale->payments->sum('return_amount')) }}" placeholder="{{ __('sale.Enter Amount') }}">
                                                           </div>
                                                       </div>
                                                       <div class="col-md-6 col-lg-6 col-sm-12">
                                                           <div class="primary_input mb-15">
                               ...
                               <div class="col-lg-12 text-center pt_15">
                                   <div class="total_quantity_buttons">
                                       ...
                                       <div class="payment_buttons">
                                           <button type="button"
                                                   class="primary_color_btn dark_btn">{{single_price($sale->payable_amount)}}</button>
