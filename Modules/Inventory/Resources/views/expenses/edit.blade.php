                                    ...
                                    @foreach ($credit_accounts as $key => $credit_account)
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="sub_amount[]" placeholder="{{ __('account.Amount') }}" type="number" value="{{ $credit_account->amount }}"  step="0.01">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="sub_narration[]" placeholder="{{ __('account.Narration') }}" type="text" value="{{ $credit_account->narration }}">
    ...
    <script type="text/javascript">
        ...
        function get_dynamic_text(){
            ...
            if (account_type == 'debit') {
                $("#dynamic_text").html("---- "+trans('js.Please Enter Your Credit details')+" ----");
            }else {
                $("#dynamic_text").html("---- "+trans('js.Please Enter Your Debit details') +" ----");
            }
        }
