<?php return [
    ...
    "variation_value_used" => "This variation value has used on product. You can not delete this variation",
    ...
    "Model Added Successfully" => "Model Added Successfully",
    "Model Updated Successfully" => "Model Updated Successfully",
    "Model Deleted Successfully" => "Model Deleted Successfully",

    "Unit Type Added Successfully" => "Unit Type Added Successfully",
    "Unit Type Updated Successfully" => "Unit Type Updated Successfully",
    "Unit Type Deleted Successfully" => "Unit Type Deleted Successfully",
