                                ...
                                <div class="main-title d-flex flex-wrap">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center  flex-wrap flex-grow-1">
                                        <ul class="d-flex flex-wrap">
                                            <li><a download class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{ asset('public/uploads/staff.xlsx') }}"><i class="ti-import"></i>{{ __('common.Sample File Download') }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
