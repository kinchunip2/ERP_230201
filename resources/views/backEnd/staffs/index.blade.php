                    ...
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            ...
                            <ul class="d-flex">
                                ...
                                @endif
                                    @if(permissionCheck('staffs.csv_upload.store'))
                                <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{route('staffs.csv_upload.create')}}"><i class="ti-export"></i>{{__('common.Upload Via CSV')}}</a></li>
                                    @endif
                            </ul>
                        </div>
                    </div>
